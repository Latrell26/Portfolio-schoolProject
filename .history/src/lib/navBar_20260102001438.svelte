...
>
    ...
    <button 
        on:click={toggleDark} 
        class="p-2 rounded-full bg-yellow-400 dark:bg-gray-700 transition-colors duration-300"
    ...
    >
        ...
        {:else}
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 3v1m0 16v1m8.66-12.66l-.71.71M4.05 19.95l-.71.71M21 12h-1M4 12H3m16.66 4.66l-.71-.71M4.05 4.05l-.71-.71M12 5a7 7 0 100 14 7 7 0 000-14z" />
            </svg>
        {/if}
    </button>
