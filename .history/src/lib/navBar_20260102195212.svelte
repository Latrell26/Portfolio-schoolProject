...
<nav
    ...
    bg-transparent
    ${scrolled
        ? "bg-white/10 border-b border-white/20 backdrop-blur-xl shadow-md"
...
>
    <div class="flex justify-between items-center max-w-7xl mx-auto px-4">
        ...
        <button
            ...
            class="relative w-14 h-7 rounded-full bg-white shadow-md flex items-center cursor-pointer"
        >
            <div
