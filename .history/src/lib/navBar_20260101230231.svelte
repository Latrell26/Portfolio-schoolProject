<script>
    ...
    // Bagong dagdag para sa hide/show navbar
    let prevScrollY = 0;
    ...
    onMount(() => {
        const handleScroll = () => {
            ...
            // Existing: blur effect kapag nag-scroll > 50px
            scrolled = currentScrollY > 50;

            // Bagong feature: hide navbar pag scroll down, show pag scroll up
            ...
            // Always show kapag nasa top na (para hindi mag-stuck sa hidden)
        ...
        // Existing: active section highlighting
...
>
    ...
    <ul class="flex flex-col gap-6 text-xl">
        <li><a href="#home" on:click={() => menuOpen = false} class={activeSection === "home" ? "underline" : ""}>Home</a></li>
        <li><a href="#about" on:click={() => menuOpen = false} class={activeSection === "about" ? "underline" : ""}>About</a></li>
        <li><a href="#projects" on:click={() => menuOpen = false} class={activeSection === "projects" ? "underline" : ""}>Projects</a></li>
        <li><a href="#contact" on:click={() => menuOpen = false} class={activeSection === "contact" ? "underline" : ""}>Contact</a></li>
    </ul>
</div>