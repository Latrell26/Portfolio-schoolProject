...
>
  <div class="flex justify-between items-center max-w-7xl mx-auto px-4">
   ...
   <button class="md:hidden text-3xl font-bold" on:click={() => menuOpen = !menuOpen}>
  {#if menuOpen}
    ✕
  {:else}
    ☰
...
<div
  class={`fixed top-0 right-0 h-full w-64 bg-black/80  backdrop-blur-xl text-white p-6 z-70
