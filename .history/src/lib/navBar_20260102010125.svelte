...
>
    ...
    class="relative w-10 h-10 rounded-full bg-white flex items-center transition duration-300 focus:outline-none shadow-lg"
    aria-label="Toggle dark mode"
>
    <div
        class="w-8 h-8 relative rounded-full transition-all duration-500 transform p-1 text-white flex items-center justify-center
