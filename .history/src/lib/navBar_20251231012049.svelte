  ...
  <div class="flex justify-between items-center max-w-300 mx-auto">
    ...
    <ul class="hidden md:flex gap-12 text-lg">
      <li class="hover:underline cursor-pointer">
        <a href="#home" class={activeSection === "home" ? "underline font-bold" : ""}>Home</a>
      </li>
      <li class="hover:underline cursor-pointer">
        <a href="#about" class={activeSection === "about" ? "underline font-bold" : ""}>About</a>
      </li>
      <li class="hover:underline cursor-pointer">
        <a href="#projects" class={activeSection === "projects" ? "underline font-bold" : ""}>Projects</a>
      </li>
      <li class="hover:underline cursor-pointer">
        <a href="#contact" class={activeSection === "contact" ? "underline font-bold" : ""}>Contact</a>
      </li>
    </ul>
...
>
  ...
  <ul class="flex flex-col gap-6 text-xl">
    <li><a href="#home" class={activeSection === "home" ? "underline font-bold" : ""}>Home</a></li>
    <li><a href="#about" class={activeSection === "about" ? "underline font-bold" : ""}>About</a></li>
    <li><a href="#projects" class={activeSection === "projects" ? "underline font-bold" : ""}>Projects</a></li>
    <li><a href="#contact" class={activeSection === "contact" ? "underline font-bold" : ""}>Contact</a></li>
  </ul>
</div>
