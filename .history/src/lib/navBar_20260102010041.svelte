...
>
    ...
    class="relative w-12 h-7 rounded-full bg-gray-300 flex items-center transition duration-300 focus:outline-none shadow-md"
    aria-label="Toggle dark mode"
>
    <div
        class="w-6 h-6 absolute rounded-full transition-all duration-500 transform flex items-center justify-center
               {isDark 
                 ? 'bg-gray-700 translate-x-5' 
                 : 'bg-yellow-400 translate-x-0.5'}"
    >
        <div class="w-5 h-5">
            {@html currentIcon}
        </div>
