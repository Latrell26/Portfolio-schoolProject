    ...
    ${
        scrolled
        ? "bg-white/10 backdrop-blur-xl border-b border-white/20 shadow-sm"
        : ""
    }`}
    >
    ...
    <!-- MOBILE MENU -->
    <div
    class={`fixed top-0 right-0 h-full w-64 backdrop-blur-xl text-white p-6 z-40 transition-transform duration-300
